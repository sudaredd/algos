...
public class UniquePaths {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new UniquePaths().uniquePaths_practce(3, 2));
        System.out.println(new UniquePaths().uniquePaths_practce(7, 3));
    }

    public int uniquePaths_practce(int m, int n) {
